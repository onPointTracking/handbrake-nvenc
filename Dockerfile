...
ENV DVDCSS_URL https://www.deb-multimedia.org/pool/main/libd/libdvdcss-dmo/libdvdcss2_1.4.3-dmo1_amd64.deb
...
RUN wget $DVDCSS_URL
RUN apt install -y ./libdvdcss2_1.4.3-dmo1_amd64.deb
